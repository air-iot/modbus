...
func NewTCPServerHandler(conn net.Conn) *TCPServerHandler {
	//h := &TCPServerHandler{}
	//h.Address = address
...
func TCPServer(conn net.Conn) Client {
	handler := NewTCPServerHandler(conn)
...
// tcpServerTransporter implements Transporter interface.
